...
times=Button(frame,text="*",height=4,width=9,font=35,command=lambda :button_press("*"))
times.grid(row=2,column=3)

division=Button(frame,text="/",height=4,width=9,font=35,command=lambda :button_press("/"))
...
clear=Button(window,text="CE",height=4,width=12,font=35,command=clear)
clear.pack()
